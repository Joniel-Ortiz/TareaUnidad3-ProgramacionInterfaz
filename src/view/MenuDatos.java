...
public class MenuDatos extends JFrame {
	...
	private void initComponents() {
		...
		//======== panel1 ========
		{
			...
			lblTelefono.setIcon(new ImageIcon(getClass().getResource("/icons/6361846(1).png")));
			...
			lblCorreo.setIcon(new ImageIcon(getClass().getResource("/icons/8679834(1).png")));
			...
			//---- lblFoto ----
			lblFoto.setIcon(new ImageIcon(getClass().getResource("/icons/12058199(1)(1).png")));

			//---- btnLllamar ----
			btnLllamar.setIcon(new ImageIcon(getClass().getResource("/icons/6361846(1).png")));
			...
			//---- btnEditar ----
			btnEditar.setIcon(new ImageIcon(getClass().getResource("/icons/1703792(1).png")));
			...
			//---- btnEliminar ----
			btnEliminar.setIcon(new ImageIcon(getClass().getResource("/icons/2496740(1).png")));
